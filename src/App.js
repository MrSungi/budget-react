...
function App() {
  return (<Container>
    ...
    <Segment color='red'>
      <Grid columns={3} textAlign='right'>
        <Grid.Row>
          ...
          <Grid.Column width={3}>
            <Icon name='edit' bordered="bordered"/>
            <Icon name='trash' bordered="bordered"/>
          </Grid.Column>
        </Grid.Row>
      </Grid>
    </Segment>
    ...
    <Segment color='red'>
      <Grid columns={3} textAlign='right'>
        <Grid.Row>
          <Grid.Column width={10} textAlign='left'>Something Other</Grid.Column>
